      ...
      >
        ...
        <div className="absolute h-full w-full [backface-visibility:hidden]">
          <img
            src={image}
            alt="image"
            className="h-full w-full rounded-2xl object-contain shadow-2xl shadow-black/40"
          />
          <div className="absolute bottom-4 left-5 text-xl font-bold text-black">{title}</div>
        </div>
